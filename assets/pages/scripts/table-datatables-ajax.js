var TableDatatablesAjax = function () {
    ...
    var handleDemo1 = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": baseUrl + "admin/transactions/getAllTransaction", // ajax source
                },
                "order": [
                    [1, "asc"]
	...
	var handleUserTrans = function () {
		
        var grid = new Datatable();
		
        grid.init({
            src: $("#datatable_userTrans"),
            onSuccess: function (grid, response) {
                // grid:        grid object
                // response:    json object of server side ajax response
                // execute some code after table records loaded
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "bStateSave": true, 
                 ...
                 // save custom filters to the state
                "fnStateSaveParams":    function ( oSettings, sValue ) {
                    $("#datatable_userTrans tr.filter .form-control").each(function() {
                        sValue[$(this).attr('name')] = $(this).val();
                    });
                ...
                "pageLength": 50, // default record count per page
                "ajax": {
                    "url": baseUrl + "users/getAllTransaction", // ajax source
                },
                "order": [
                    [1, "asc"]
                ]// set first column as a default sort by asc
