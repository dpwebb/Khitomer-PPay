              ...
              <div class="form-body">
                  ...
                  <div class="col-md-6">
                    <div class="form-group <?php if(form_error('billing_state') != "") echo 'has-error'; ?>">
                      ...
                      <select class="form-control" name="billing_state" id="billing_state">
                        ...
                        ?>
                                <option value="<?php echo $row->code;?>" <?php echo set_select('billing_state', $row->code);?>><?php echo $row->name;?></option>
                        <?php } }?>
                      </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group <?php if(form_error('billing_country') != "") echo 'has-error'; ?>">
                      ...
                      <select class="form-control" name="billing_country" id="billing_country">
                          <option value="USA" <?php echo set_select('billing_country', 'USA');?>>United States</option>
                        </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="shipping_state" id="shipping_state">
                        ...
                        ?>
                                <option value="<?php echo $row->code;?>" <?php echo set_select('shipping_state', $row->code);?>><?php echo $row->name;?></option>
                        <?php } }?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="shipping_country" id="shipping_country">
                          <option value="USA" <?php echo set_select('shipping_country', 'USA');?>>United States</option>
                        </select>
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input name="cardnumber" type="text" class="form-control" value="<?php echo set_value('cardnumber');?>" placeholder="Order Description">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input name="cardCVV" type="text" class="form-control" value="<?php echo set_value('cardCVV');?>" placeholder="Security Code i.e xxx">
                  ...
                  <div class="col-md-6">
                    <div class="form-group <?php if(form_error('amount') != "") echo 'has-error'; ?>">
                      ...
                      <input name="amount" type="text" class="form-control" value="<?php echo set_value('amount');?>" placeholder="Amount i.e 100.50">
