  ...
  <div class="page-content"> 
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption"> <i class="fa fa-bell" style="color:#00b300;"></i> <span style="color:#00b300;" class="caption-subject bold uppercase">Important Notice</span> </div>
      ...
      <div class="portlet-body">
        ...
        <blockquote>
          ...
          <p style="margin-bottom:7px;">Thank you for your patience CF Mercantile is back online they have fix their problem</p>
          <!--<p style="color:#00b300;">ACH and eCheck processing is not affected by this issue.</p>-->
          <small>David Webb </small>
          <small>CEO </small></blockquote>
        <div class="clearfix">
      ...
      <div class="col-lg-12 col-xs-12 col-sm-12">
        <div class="portlet light bordered">
          <div class="portlet-title tabbable-line">
            <div class="caption"> <i class="icon-bubbles font-dark hide"></i> <span class="caption-subject font-dark bold uppercase">Transactions Stats</span> </div>
            <ul class="nav nav-tabs">
              <li class="active"> <a href="#portlet_alltime" data-toggle="tab" aria-expanded="true"> All Time </a> </li>
              <li class=""> <a href="#portlet_today" data-toggle="tab" aria-expanded="false"> Today </a> </li>
              <li class=""> <a href="#portlet_lastweek" data-toggle="tab" aria-expanded="false"> last Week </a> </li>
            </ul>
          </div>
          <div class="portlet-body">
                  ...
                  <div class="col-md-3"> 
                    ...
                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                      ...
                      <div class="widget-thumb-wrap">
                        <div class="widget-thumb-body"> <span class="widget-thumb-subtitle">US Dollar (<i class="fa fa-usd" aria-hidden="true"></i>)</span> <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?php echo number_format($approvedTrans['totalBalanceUSD'], 2);?>"><?php echo number_format($approvedTrans['totalBalanceUSD'], 2);?></span> <span class="widget-thumb-subtitle">Pound Sterling (<i class="fa fa-gbp" aria-hidden="true"></i>)</span> <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?php echo number_format($approvedTrans['totalBalanceGBP'], 2);?>"><?php echo number_format($approvedTrans['totalBalanceGBP'], 2);?></span> <span class="widget-thumb-subtitle">Euro (<i class="fa fa-eur" aria-hidden="true"></i>)</span> <span class="widget-thumb-body-stat" data-counter="counterup" data-value="<?php echo number_format($approvedTrans['totalBalanceEUR'], 2);?>"><?php echo number_format($approvedTrans['totalBalanceEUR'], 2);?></span> </div>
                      </div>
                    </div>
                    <!-- END WIDGET THUMB --> 
                  </div>
