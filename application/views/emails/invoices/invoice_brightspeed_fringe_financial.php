...
Thank you</strong></h3>
    ...
    <tr>
      <td colspan="2" style="background-color:#eeeeee; color:#434343; font-size: 12px; padding: 10px;"><p>Fringe Financial is a billing company that services your sales affiliate <?php echo $affiliateName;?>, and has taken this amount from your bank account on your authorization given to the Sales Person. If you have any issues with this transaction or the product or services you have purchased please call us immediately at 1-844-922-7436.</p></td>
    </tr>
    ...
    <tr>
      <td colspan="2" align="center" class="footer" style="background-color:#145881; padding:10px; font-size:10px; color:#FFFFFF;">2017 &copy; Fringe Financial </td>
    </tr>
  </tbody></table>
</div>