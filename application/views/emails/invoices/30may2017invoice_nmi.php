...
<table style="font-family:Verdana,sans-serif; font-size:11px; color:#374953; width: 600px;" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td align="left" style="background-color:#FFFFFF; padding:10px 10px 10px 0px;" width="67%"><a href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/pages/img/'.$NMILogo);?>" alt="<?php echo $site_name;?>" height="90px"/></a></td>
    ...
    <table>
    	<tr>
          <td width="250" style="padding:10px; text-align:right;">
            <a href="<?php echo $NMIURL.'/rejected'?>" target="_blank"><img src="<?php echo base_url('assets/pages/img/rejected.jpg');?>" alt="Reject" height="55px"></a>
          </td>
          <td width="350" style="padding:10px; text-align:left;">
          	<a href="<?php echo $NMIURL.'/approved'?>" target="_blank"><img src="<?php echo base_url('assets/pages/img/approved.jpg');?>" alt="Approve" height="110px"></a>
          </td>	
         </tr>
    </table>
    </td>
    ...
    <tr>
      <td align="center" style="background-color:#145881; padding:10px; font-size:10px; color:#FFFFFF;" colspan="2"><?php echo date('Y'); ?> @ Priority Payout</td>
    </tr>
  </tbody>
</table>
</div>