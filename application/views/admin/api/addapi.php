              ...
              <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                 <?php if (validation_errors() != "") { ?>
                  ...
                  <?php } ?>
                      <form role="form" action="<?php echo base_url('admin/khitomerapi/addapi/'.$parentId);?>" method="post">
                      <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="api_currency">
                              ...
                              <?php foreach($currency as $row){?>
                                <option value="<?php echo $row->code;?>" <?php echo set_select('api_currency', $row->code);?>><?php echo $row->title;?></option>
                              <?php }?>
                            </select>
                        </div>
                        <div class="form-group">
