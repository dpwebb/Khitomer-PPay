...
<div class="page-content-wrapper"> 
  ...
  <div class="page-content"> 
    ...
    <ul class="page-breadcrumb breadcrumb">
      ...
      <li> <a href="<?php echo base_url('admin/khitomerapi/index/'.$parentId);?>">Our Apis</a> <i class="fa fa-circle"></i> </li>
              ...
              <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                 <?php if (validation_errors() != "") { ?>
                  ...
                  <?php } ?>
                      <form role="form" action="<?php echo base_url('admin/khitomerapi/editapi/'.$parentId.'/'.$apiID);?>" method="post">
                      <div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
                      	<div class="form-group">
                            <label class="control-label">Api Default Currency</label>
                            <select class="form-control" name="api_currency">
                              <option value="">Select Api Default Currency</option>
                              <?php foreach($currency as $row){?>
                                <option value="<?php echo $row->code;?>" <?php if(validation_errors()!='') echo set_select('api_currency', $row->code); elseif($ApiInfo->api_currency==$row->code) echo 'selected="selected"';?>><?php echo $row->title;?></option>
                              <?php }?>
                            </select>
                        </div>
