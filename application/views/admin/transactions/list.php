        ...
        <div class="portlet light bordered">
	     ...
	     ?>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                  <label class="control-label">Last 4 Digits Of Credit Card</label>
                  <input type="text" name="card_number" class="form-control" placeholder="xxxx" value="<?php if($this->session->userdata('card_number')!='') echo $this->session->userdata('card_number');?>">
              </div>
            </div>
          	<div class="col-md-3">
                <div class="form-group">
                  <label class="control-label">Credit Card Expiry</label>
                  <input type="text" name="expiry_date" class="form-control" placeholder="xx/xxxx" value="<?php if($this->session->userdata('expiry_date')!='') echo $this->session->userdata('expiry_date');?>">
              </div>
            </div>
          ...
          <div class="row">
         	<div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" name="amount" class="form-control" placeholder="0.00" value="<?php if($this->session->userdata('amount')!='') echo $this->session->userdata('amount');?>">
              </div>
            </div>
          	<div class="col-md-3">
                <div class="form-group">
