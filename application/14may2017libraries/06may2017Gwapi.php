...
// Initial Setting Functions
  ...
  function setBilling($userData, $companyName) {
    ...
    $this->billing['firstname'] = $userData['billing_first_name'];
    $this->billing['lastname']  = $userData['billing_last_name'];
    $this->billing['company']   = $companyName;
    $this->billing['address1']  = $userData['billing_address_1'];
    $this->billing['address2']  = $userData['billing_address_2'];
    $this->billing['city']      = $userData['billing_city_name'];
    $this->billing['state']     = $stateCode;
    $this->billing['zip']       = $userData['billing_zip_code'];
    $this->billing['country']   = $countryCode;
    $this->billing['phone']     = $userData['billing_phone_no'];
    $this->billing['fax']       = '';
    $this->billing['email']     = $userData['billing_email'];
  ...
  function setShipping($userData, $companyName) {
	...
	$countryCode= getColumnValue('country', 'iso_code_2', $where='country_id='.$userData['shipping_country_id']);
	$stateCode	= getColumnValue('states', 'code', $where='state_id='.$userData['shipping_state_id']);
	
	$this->shipping['firstname'] = $userData['shipping_first_name'];
    $this->shipping['lastname']  = $userData['shipping_last_name'];
    $this->shipping['company']   = $companyName;
    $this->shipping['address1']  = $userData['shipping_address_1'];
    $this->shipping['address2']  = $userData['shipping_address_2'];
    $this->shipping['city']      = $userData['shipping_city_name'];
	if($stateCode!=false)
    	$this->shipping['state']     = $stateCode;
    $this->shipping['zip']       = $userData['shipping_zip_code'];
	if($countryCode!=false)
    	$this->shipping['country']   = $countryCode;
    $this->shipping['email']     = '';
  }
