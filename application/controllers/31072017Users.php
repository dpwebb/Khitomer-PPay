...
class Users extends Public_Controller {
	...
	public function paytoonotification(){
		...
		$updateTrans['transaction_status']			= $_POST['MerchantApiResponse']['tr_status'];
		$updateTrans['system_transaction_status']	= strtolower($_POST['MerchantApiResponse']['tr_status']);
		$updateTrans['transaction_msg']				= 'Transaction '.strtolower($_POST['MerchantApiResponse']['tr_status']);
		
		$whereArr = array('trans_api_id'=>2, 'transaction_id'=>$_POST['MerchantApiResponse']['tr_id']);
		...
		$subject = "status is".$_POST['MerchantApiResponse']['tr_status'];
		$txt = "here is message ".$string.' has value '.$_POST['MerchantApiResponse']['hash'];
