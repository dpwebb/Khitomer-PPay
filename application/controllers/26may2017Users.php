...
class Users extends Public_Controller {
	...
	public function processpayment(){
		...
		/*$getApiList	=  $this->users_model->getUserAPI($this->session->userdata('userID'), 'cc');
	...
	public function achpayment(){
		...
		if ($this->form_validation->run() == false){
			...
			$transData['transaction_type']		= 'ach';
			...
			$transData['transaction_status'] = 'pending';
	...
	public function directPayExpress(){
		...
		if($notifyType=='TransactionStatusChanged'){
			...
			if($_POST['trans_status']==1)
				$updateTrans['transaction_status'] = 'success';
			else
