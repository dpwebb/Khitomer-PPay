...
class Transactions extends Public_Controller {
	...
	public function index(){
		...
		if(isset($_POST['card_number']) && $this->input->post('clear')!='clear'){
			$this->session->set_userdata('card_number', $this->input->post('card_number'));
		}
		
		if(isset($_POST['expiry_date']) && $this->input->post('clear')!='clear'){
			$this->session->set_userdata('expiry_date', $this->input->post('expiry_date'));
		}
		
		if(isset($_POST['amount']) && $this->input->post('clear')!='clear'){
